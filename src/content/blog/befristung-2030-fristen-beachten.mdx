...
image:
  fileName: "befristung-projektplanung"
  alt: "Zwei Personen ordnen die zeitlichen Schritte eines Bauvorhabens an einer Planungstafel"
  caption: "KI-generiertes Symbolbild · keine echte Terminplanung"
  kind: "ki-symbolbild"
  ...
  purpose: "Macht die notwendige Ablauf- und Fristplanung eines befristeten Verfahrens sichtbar."
  ...
  checks:
    ...
    rightsVerified: true
quickAnswer: "Die Sonderregelung des § 246e BauGB ist befristet. Für die eigene Zeitplanung reicht es deshalb nicht, nur einen Antragstag zu betrachten; entscheidend sind der konkrete Verfahrensstand und die gesetzlichen Übergangsfragen."
keyPoints:
  - "Die Befristung ersetzt keine Prüfung der übrigen Genehmigungsvoraussetzungen."
  - "Gemeindeabstimmung, Unterlagen und offene Fachfragen sollten frühzeitig vorbereitet werden."
  - "Auf eine spätere Verlängerung sollte die Vorhabenplanung nicht gestützt werden."
pubDate: 2026-01-14
...
primaryIntent: "befristung-2030-verstehen"
primaryQuery: "Bis wann kann § 246e BauGB angewendet werden?"
parentHub: "/246e-baugb-brandenburg/"
lifecycleStatus: "aktuell"
legalAsOf: 2026-07-14
sources:
  - label: "§ 246e BauGB – Gesetzestext (Enddatum in Abs. 1 Satz 1, Reichweite in Abs. 4)"
  ...
  - label: "BMWSB – Bau‑Turbo: Informationen für Privatpersonen"
    ...
    type: "secondary"
  - label: "MIL Brandenburg – FAQ Block E, Stand Juli 2026 (insb. E5)"
