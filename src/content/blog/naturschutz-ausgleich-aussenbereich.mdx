...
sources:
  ...
  - label: "§ 44 BNatSchG – Artenschutz (Zugriffsverbote)"
...
- **Eingriffsregelung (§ 18 BNatSchG):** Es geht um Beeinträchtigungen von Natur und Landschaft durch das Vorhaben und um Vermeidung, Minimierung sowie Ausgleich/Ersatz.
...
Beide Themen können parallel auftreten. Deshalb ist es sinnvoll, im Kurz‑Dossier klar zu trennen, welche Informationen Sie schon haben (z. B. Standortscreening) und wo eine fachliche Klärung im Verfahren nötig sein kann.
