...
§ 246e BauGB kann Wohnvorhaben erleichtern – aber er ersetzt **nicht** das Naturschutzrecht. Im Außenbereich ist das besonders relevant, weil dort Landschaft, Arten und Biotope häufig stärker betroffen sein können. § 246e Abs. 3 BauGB enthält dazu ausdrücklich Vorgaben: Naturschutzbelange werden im Verfahren eingebunden, und für Eingriffe ist regelmäßig ein **Ausgleich oder Ersatz** nach dem Bundesnaturschutzgesetz (BNatSchG) zu prüfen.
