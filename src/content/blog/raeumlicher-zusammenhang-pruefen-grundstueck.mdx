...
image:
  fileName: "raeumlicher-zusammenhang-flurstueck-16x9"
  alt: "Illustrative Darstellung eines fiktiven Flurstücksplans mit markiertem Siedlungsrand und Grundstück"
  ...
  schemaImages:
    - "raeumlicher-zusammenhang-flurstueck-1x1"
    - "raeumlicher-zusammenhang-flurstueck-4x3"
    - "raeumlicher-zusammenhang-flurstueck-16x9"
  provenanceStatus: "bestand-unvollstaendig"
  provenanceNote: "Das ursprüngliche Erzeugungsdatum des Bestandsmotivs ist nicht dokumentiert; Motiv und Dateien wurden am 15. Juli 2026 redaktionell geprüft."
  purpose: "Veranschaulicht ausschließlich die Lagebeziehung zwischen Siedlungsbereich und Grundstück."
  ...
  checks:
    ...
    rightsVerified: true
quickAnswer: "Die 100-Meter-Angabe ist eine Leitplanke aus der Gesetzesbegründung und keine gesetzliche Baugrenze. Für eine belastbare Vorprüfung müssen Referenzsiedlung, Entfernung, Trennwirkungen und funktionale Anbindung gemeinsam dokumentiert werden."
keyPoints:
