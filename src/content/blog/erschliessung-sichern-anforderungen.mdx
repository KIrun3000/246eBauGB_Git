...
description: "Welche Erschließung muss für § 246e‑Vorhaben geklärt sein? Leitfragen zu Zufahrt, Wegerechten, Wasser/Abwasser und Strom – ohne Kostenmythen, mit Prüfliste."
image:
  fileName: "erschliessung-grundstueck"
  alt: "Vor-Ort-Prüfung von Zufahrt und Versorgungsanschlüssen an einem unbebauten Grundstück"
  ...
  purpose: "Zeigt die Vor-Ort-Prüfung von Zufahrt, Grundstücksbezug und Versorgungsanschlüssen."
  ...
  checks:
    ...
    rightsVerified: true
quickAnswer: "Die planungsrechtliche Erleichterung durch § 246e BauGB ersetzt keine gesicherte Erschließung. Zufahrt, Rechte sowie Ver- und Entsorgung sollten deshalb schon vor einer vertieften Planung als prüfbare Themen dokumentiert sein."
keyPoints:
  - "Eine vorhandene Straße beantwortet Zufahrt und Wegerechte nicht automatisch."
  - "Wasser, Abwasser und Strom sind getrennt mit den zuständigen Stellen zu klären."
  - "Für das Verfahren zählt ein nachvollziehbarer Klärungsstand, nicht eine unbelegte Zusage."
pubDate: 2026-01-11
...
sources:
  ...
  - label: "BMWSB – Bau‑Turbo: Informationen für Privatpersonen"
    ...
    type: "secondary"
  - label: "MIL Brandenburg – FAQ Block E, Stand Juli 2026 (insb. E3)"
...
Dieser Beitrag hilft Ihnen, Erschließung systematisch zu klären – ohne Kosten‑ oder Zeitversprechen. Für den Kontext: [§ 246e BauGB in Brandenburg](/246e-baugb-brandenburg/) und für Außenbereichsfragen: [Außenbereich Brandenburg – Prüfung und Stolpersteine](/aussenbereich-brandenburg-246e/).
...
Wenn Ihr Vorhaben im Außenbereich liegt, ist außerdem wichtig, Erschließung und „räumlichen Zusammenhang“ getrennt zu betrachten: Auch bei räumlichem Zusammenhang (siehe [100‑m‑Leitplanke](/100m-regel-raeumlicher-zusammenhang/)) bleibt Erschließung ein eigenständiges Thema.
