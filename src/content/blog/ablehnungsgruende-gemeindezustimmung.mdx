...
image:
  fileName: "ablehnung-gemeinde-planbesprechung"
  alt: "Zwei Personen besprechen mögliche Änderungen an einem schematischen Grundstücksplan"
  caption: "KI-generiertes Symbolbild · keine echten Planunterlagen"
  kind: "ki-symbolbild"
  origin: "intern-erzeugt"
  creator: "Codex-Bildgenerierung von OpenAI; Zuschnitt durch Redaktion 246eBauGB"
  rightsBasis: "Projektinterne redaktionelle Nutzung"
  createdAt: 2026-07-15
  provenanceStatus: "vollstaendig"
  purpose: "Zeigt die sachliche Überarbeitung eines Vorhabens nach einer ablehnenden Entscheidung."
  ...
  checks:
    ...
    rightsVerified: true
quickAnswer: "Eine verweigerte Zustimmung bedeutet, dass das Vorhaben in dieser Form nicht genehmigungsfähig ist. Prüfen Sie die Entscheidung nach Norm, Tatsachen und Schlussfolgerung und arbeiten Sie nur die konkret benannten Punkte gezielt nach."
keyPoints:
  - "Gemeindeentscheidung und Prüfung der Genehmigungsbehörde sind getrennt einzuordnen."
  - "Bescheid, Begründung und Rechtsbehelfsbelehrung bilden den Ausgangspunkt."
  - "Ein überarbeiteter Antrag kann sinnvoll sein, wenn sich die tragenden Gründe ausräumen lassen."
pubDate: 2026-01-16
...
searchTask: "reagieren"
primaryIntent: "gemeindezustimmung-ablehnung-verstehen"
primaryQuery: "Gemeindezustimmung nach § 36a abgelehnt – was tun?"
...
sources:
  ...
  - label: "BMWSB – Bau‑Turbo: Informationen für Privatpersonen"
    ...
    type: "secondary"
  - label: "MIL Brandenburg – FAQ Block F, Stand Juli 2026 (insb. F8–F15)"
...
- **Lage und Siedlungsentwicklung:** Welche städtebaulichen Folgen hat die Randlage? Die förmliche Tatbestandsprüfung des räumlichen Zusammenhangs bleibt Aufgabe der Genehmigungsbehörde. (Vertiefung: [100‑m‑Leitplanke](/100m-regel-raeumlicher-zusammenhang/))
...
Als Einstieg empfehlen sich die Grundlagenseiten [§ 246e BauGB in Brandenburg](/246e-baugb-brandenburg/) und [Zustimmung der Gemeinde](/zustimmung-gemeinde-246e/).
