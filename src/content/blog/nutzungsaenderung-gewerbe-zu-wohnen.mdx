...
Bei Nutzungsänderungen ist der **genehmigte Bestand** entscheidend. Je klarer Sie dokumentieren, was vorhanden ist und was sich ändern soll, desto besser können Gemeinde und Bauaufsicht prüfen. Ohne Anspruch auf Vollständigkeit können folgende Unterlagen helfen:
...
Wenn Unterlagen fehlen, kann es sinnvoll sein, bei Gemeinde/Bauaufsicht nach vorhandenen Akten zu fragen. Für den formalen Einstieg ist die Gemeindezustimmung nach § 36a BauGB der zentrale Schritt.
