...
„Hinterlandbebauung“ oder „Bauen in 2. Reihe“ klingt nach einer einfachen Idee: Auf dem Grundstück hinter einem bestehenden Haus soll zusätzlicher Wohnraum entstehen. Planungsrechtlich ist das aber oft anspruchsvoll, weil Fragen wie **Innenbereich (§ 34 BauGB) vs. Außenbereich (§ 35 BauGB)**, **Erschließung**, **Einfügung** und **Ortsbild** ineinandergreifen.
...
Im § 34‑Innenbereich müssen sich Vorhaben in die Eigenart der näheren Umgebung einfügen. Bei 2. Reihe stellen sich dabei häufig Fragen wie:
...
Bei § 246e ist die **Gemeindezustimmung nach § 36a BauGB** zentral. Für 2. Reihe ist das besonders wichtig, weil Gemeinden Nachverdichtung oft in ein Ortsentwicklungskonzept einordnen:
...
Auch wenn § 246e planungsrechtliche Spielräume eröffnet: Erschließung bleibt ein zentrales Thema. Bei 2. Reihe geht es häufig um:
...
Häufig sind es Einordnung (Innen-/Außenbereich), Erschließung und städtebauliche Einbindung. Diese Punkte sollten Sie vor vertiefter Planung klären.
