...
description: "Wann § 246e BauGB bei Aufstockung, Anbau oder Ausbau im Innenbereich helfen kann und warum die Gemeindezustimmung entscheidend bleibt."
image:
  fileName: "aufstockung-anbau-wohnhaus"
  alt: "Wohnhaus mit hölzernem Dachaufbau und seitlichem Anbau während einer Planungsbesichtigung"
  caption: "KI-generiertes Symbolbild · kein reales Bauvorhaben"
  kind: "ki-symbolbild"
  ...
  purpose: "Veranschaulicht Aufstockung und Anbau an einem gewöhnlichen Wohnhaus im Bestand."
  ...
  checks:
    ...
    rightsVerified: true
quickAnswer: "§ 246e BauGB kann für eine Aufstockung oder einen Anbau relevant werden, wenn dadurch Wohnraum entsteht und planungsrechtliche Hürden zu klären sind. Eine automatische Zulassung folgt daraus nicht."
keyPoints:
  - "Zuerst ist zu klären, ob Bebauungsplan oder unbeplanter Innenbereich maßgeblich sind."
  - "Das Wohnraumziel und die gewünschte Abweichung müssen konkret beschrieben werden."
  - "Gemeindezustimmung, Bauordnungsrecht und mögliche Nachbarkonflikte bleiben eigenständig zu prüfen."
pubDate: 2026-01-10
...
primaryIntent: "aufstockung-anbau-anwendungsbereich-pruefen"
primaryQuery: "Aufstockung oder Anbau mit § 246e vorprüfen"
...
sources:
  ...
  - label: "BMWSB – Bau‑Turbo: Informationen für Privatpersonen"
    ...
    type: "secondary"
  - label: "MIL Brandenburg – FAQ Block E, Stand Juli 2026 (insb. E15)"
...
3. **§ 246e‑Bezug herstellen:** Welche neue Wohnung entsteht oder welcher vorhandene Wohnraum wird wieder nutzbar? Eine bloße Erweiterung einer bestehenden Wohnung reicht nicht.
4. **Gemeinde früh einbinden:** Kurzübersicht und Gespräch; Ziel: klären, ob die Gemeinde zustimmen würde.
...
Hinweis: Wenn Ihr Vorhaben Außenbereichsbezug hat (z. B. Randlagen), prüfen Sie zusätzlich die Themen auf der Grundlagenseite [100‑m‑Leitplanke & räumlicher Zusammenhang](/100m-regel-raeumlicher-zusammenhang/).
